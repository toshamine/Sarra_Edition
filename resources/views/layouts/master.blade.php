...
<html>
  <head>
    ...
    <title>Admin Sarra Edition | Sarra Edition</title>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{{asset('assets/dist/img/Tosh.jpg')}}" class="user-image" alt="User Image">
                  <span class="hidden-xs">Amine Ben Chiba</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="{{asset('assets/dist/img/Tosh.jpg')}}" class="img-circle" alt="User Image">
                    <p>
                      Amine Ben Chiba - Web Developer
